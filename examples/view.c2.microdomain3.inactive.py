...
# Try265
pm(f"select glu134, resi 134 and %cls_inactive")
pm(f"select arg135, resi 135 and %cls_inactive")
pm(f"select tyr136, resi 136 and %cls_inactive")
...
pm(f"set_view (\\")
pm(f"    -0.471316189,   -0.324466944,   -0.820083439,\\")
pm(f"     0.791327238,    0.254965127,   -0.555679917,\\")
pm(f"     0.389399499,   -0.910860837,    0.136600405,\\")
pm(f"     0.001613867,    0.002338512,  -51.158596039,\\")
pm(f"    79.651046753,   12.015102386,    8.592341423,\\")
pm(f"   -43.363887787,  145.824234009,  -20.000000000 )")
