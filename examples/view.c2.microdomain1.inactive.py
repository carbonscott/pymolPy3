...
# Try265
pm(f"select trp265, resi 265")
pm(f"show sticks, %trp265")
...
pm(f"hide sticks, ret_active")
pm(f"hide sticks, cls_active")
pm(f"hide everything, hoh_active")

pm(f"set_view (\\")
pm(f"    -0.696678042,   -0.467385024,    0.544210017,\\")
pm(f"    -0.570314288,   -0.099333182,   -0.815392256,\\")
pm(f"     0.435163796,   -0.878436506,   -0.197350860,\\")
pm(f"     0.000865430,    0.000551961,  -55.780338287,\\")
pm(f"    59.289150238,    9.519577026,   -6.819219112,\\")
pm(f"    15.569347382,   95.803459167,  -20.000000000 )")
