...
# Try265
pm(f"select glu134, resi 134 and %cls_active")
pm(f"select arg135, resi 135 and %cls_active")
pm(f"select tyr136, resi 136 and %cls_active")
pm(f"select glu247, resi 247 and %cls_active")
pm(f"show sticks, %glu134 or %arg135 or %tyr136 or %glu247")
...
pm(f"set_view (\\")
pm(f"    -0.050881963,   -0.253710032,   -0.965914309,\\")
pm(f"     0.996879101,    0.045390595,   -0.064448074,\\")
pm(f"     0.060191751,   -0.966189504,    0.250618219,\\")
pm(f"     0.000835389,    0.002107363,  -83.776695251,\\")
pm(f"    80.167846680,   12.697692871,   11.509057999,\\")
pm(f"   -10.483692169,  178.704406738,  -20.000000000 )")
