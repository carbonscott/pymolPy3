...
pm(f"hide sticks, average or active")
...
pm(f"set_view (\\")
pm(f"    -0.395306140,   -0.117798567,   -0.910928071,\\")
pm(f"     0.916516662,    0.014800993,   -0.399676144,\\")
pm(f"     0.060553148,   -0.992892206,    0.102128327,\\")
pm(f"     0.002914527,   -0.000923110,  -59.703811646,\\")
pm(f"    52.723499298,    9.488195419,  -14.062705994,\\")
pm(f"   -34.493373871,  154.694595337,  -20.000000000 )")
