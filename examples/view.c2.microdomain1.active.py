...
pm(f"set_view (\\")
pm(f"    -0.696678042,   -0.467384905,    0.544210017,\\")
pm(f"    -0.570314288,   -0.099333152,   -0.815392256,\\")
pm(f"     0.435163796,   -0.878436267,   -0.197350860,\\")
pm(f"     0.001220016,    0.000585346,  -63.109714508,\\")
pm(f"    61.276332855,    7.001590729,   -6.762833595,\\")
pm(f"   -22.902551651,  149.086334229,  -20.000000000 )")
